...
const AdminToolbar: React.FC<Props> = ({ selectedCount, onBlock, onUnblock, onDelete }) => {
    ...
    <div className="toolbar d-flex align-items-center mb-3">
        <button 
        className="btn btn-outline-primary me-2 d-flex align-items-center btn-sm"
        onClick={onBlock} 
        ...
        <button 
        className="btn btn-outline-success me-2 d-flex align-items-center btn-sm" 
        onClick={onUnblock} 
        disabled={!selectedCount} 
        ...
        <button 
        className="btn btn-outline-danger d-flex align-items-center btn-sm" 
        onClick={onDelete} 
        disabled={!selectedCount} 
